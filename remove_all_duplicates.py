#!/usr/bin/env python3
"""
Script to completely remove all duplicate images and ensure each image appears only once
"""
...
def remove_all_duplicates():
    ...
    # Define optimal single placement for each image (only the most important ones)
    essential_images = {
    ...
    print(f"\nAdding {len(essential_images)} essential images...")
